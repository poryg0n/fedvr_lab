...
!     wfc0 = eigenvec(:,1)/wx/dsqrt(scaling)
      ...
      allocate(dx(nmax),dwfc(nmax),dwfc2(nmax))
...
!         enddo
!  
!         call differentiation(ij, time_, x_t, dx, dx_t)
!         call differentiation(ij, time_, dx_t, dx, ddx_t)
!         call differentiation(ij, time_, p_t, dx, dp_t)
!
